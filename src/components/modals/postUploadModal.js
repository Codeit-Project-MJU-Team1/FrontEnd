...
function InnerModal({setModalOpen,id,uploadData,img}){
        ...
        return(
                ...
                <CreateModal>
                    <ModalOffButton src={exitIcon} onClick={()=>setModalOpen(false)}>
                        ...
                        <ModalName>추억 올리기</ModalName>
                        <InputOutter>
                            <GroupPWOutter>
                                <Headname>올리기 권한 인증</Headname>
                                <GroupPW type="Password" onChange={(e)=>setPassword(e.target.value)} value={password} placeholder="비밀번호를 입력해 주세요"></GroupPW>
                                </GroupPWOutter>
                            <ModalButton onClick={checkSignUp} type="submit" value="제출하기"></ModalButton>
                        </InputOutter>
...
function PostUploadModal({modalOpen,setModalOpen,id,uploadData,img}){
    ...
    return (
        <>
            ...
            // }
              >
                <InnerModal setModalOpen={setModalOpen} id={id} uploadData={uploadData} img={img}></InnerModal>
